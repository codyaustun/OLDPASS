                        ...
                        <div class="manage">
                            ...
                            while($ed = mysql_fetch_object($edQ)){
                                echo '
									<div class="storage">
										<div class="mywrap">
											<div class="ed entry" data-t="education">
                       ...
                       <!-- Education Sample Start -->
                        <div class="ed entry sample" data-t="education">
                            ...
                            <div class="col3">
                                ...
                                <div class="date">
                                    (<span class="editable" data-field="gradDate">
                                        Graduation Date
                                    </span>)
                                </div>
                	...
                	<div class="col1">
                        ...
                        <div class="manage">
                            ...
                            while($ex = mysql_fetch_object($exQ)){
                                    ...
                                    <div class="storage">
                                        <div class="mywrap">
                                            <div class="ex entry" data-t="experience">
                                                <div class="handle">
                                                    <div class="move">
                                                    </div>
                                                    <div class="cut">
                                                ...
                                                <div class="col3">
                                                    ...
                                                    <div class="date">
                                                        (<span class="editable" data-field="start">'
                                                            .$ex->start.
                                                        '</span>-
                                                        <span class="editable" data-field="endDate">'
                	...
                	<div class="col1">
                        ...
                        <div class="manage">
                            ...
                            while($act=mysql_fetch_object($actQ)){
                                    echo '
                                        <div class="storage" data-t="activities">
                                            <div class="mywrap">
                                                <div class="act entry">
                                                    <div class="handle">
                                                        <div class="move">
                    ...
                    if(mysql_num_rows($actQ)==0) echo '<div class="emptySideRow">Drag Here!</div>';
                        ...
                        while($act=mysql_fetch_object($actQ)){
                            echo '
                                            ...
                                            <div class="act entry" data-t="activities">
                                                <div class="handle">
                                                    <div class="move">
                                                    </div>
                                                    <div class="cut">
                	...
                	<div class="col1">
                        ...
                        <div class="manage">
							...
							while($sk=mysql_fetch_object($skQ)){
								...
								<div class="storage">
									<div class="mywrap">
										<div class="inter entry" data-t="interests">
											...
											<input class="editForm editableForm interest" name="interest" placeholder="Enter interest" value="'.$sk->skill.'" />
